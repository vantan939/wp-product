...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'ckeditor-js', get_template_directory_uri() . '/assets/ckeditor/ckeditor.js', array(), $theme_version, false );
	wp_script_add_data( 'ckeditor-js', 'async', false );
